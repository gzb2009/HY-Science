...
export namespace Server {
  ...
  const INTERNAL_HEADER = "x-hyscience-internal"
  ...
  export const App: () => Hono = lazy(
    () =>
      ...
      app
        ...
        .use(async (c, next) => {
          let directory = c.req.query("directory") || c.req.header("x-hyscience-directory") || process.cwd()
          try {
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current HYscience instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the HYscience instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the HYscience system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the HYscience system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the HYscience system.",
        ...
        .all("/*", async (c) => {
          const csp =
            "default-src 'self'; script-src 'self' 'wasm-unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; media-src 'self' data:; connect-src 'self' data: https://hyscience.ai https://*.hyscience.ai; object-src 'self' data: blob:; frame-src 'self' blob:"
