...
export type Project = {
  ...
  resultFolder?: string
  research?: {
    domain: "general" | "biology" | "physics" | "ml"
    subdomain?: string
    notes?: string
  }
  icon?: {
...
/**
 * Server configuration for hyscience serve and web commands
 */
...
export type Config = {
  ...
  /**
   * Agent configuration, see https://hyscience.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
...
export type SettingsComputeExecutionSetData = {
  body?: {
    execution: "local" | "ssh" | "cloud"
  }
  path?: never
  query?: never
  url: "/settings/compute/execution"
}

export type SettingsComputeExecutionSetErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SettingsComputeExecutionSetError =
  SettingsComputeExecutionSetErrors[keyof SettingsComputeExecutionSetErrors]

export type SettingsComputeExecutionSetResponses = {
  /**
   * Updated
   */
  200: {
...
export type SettingsComputeExecutionSetResponse =
  SettingsComputeExecutionSetResponses[keyof SettingsComputeExecutionSetResponses]
...
export type ProvenanceListResponse = ProvenanceListResponses[keyof ProvenanceListResponses]

export type ProvenanceQueryData = {
  body?: never
  path: {
    id: string
  }
...
export type ProvenanceQueryResponses = {
  /**
   * Lineage
   */
  200: {
...
export type ProvenanceQueryResponse = ProvenanceQueryResponses[keyof ProvenanceQueryResponses]
...
export type FileMigrateDirectoryData = {
  body?: {
    from: string
    to: string
  }
  ...
  url: "/file/directory/migrate"
}

export type FileMigrateDirectoryResponses = {
  /**
   * Migration result
   */
  200: {
...
export type FileMigrateDirectoryResponse = FileMigrateDirectoryResponses[keyof FileMigrateDirectoryResponses]
