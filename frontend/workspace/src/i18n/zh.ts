...
export const dict = {
  ...
  "dialog.provider.hysci.note": "使用 HYcloud 或 API 密钥连接",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 HYscience 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 HYscience 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 HYscience 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 hyscience.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 HYscience 服务器。",
  ...
  "dialog.project.new.title": "新建项目",
  "dialog.project.new.namePlaceholder": "项目名称",
  "dialog.project.new.directory": "项目目录",
  "dialog.project.new.directoryHint":
    "选择数据所在的父目录。每个项目会在其下建独立文件夹，不会覆盖同目录里的其他项目；结果写入该项目的 result/。",
  "dialog.project.new.directoryPlaceholder": "点击浏览选择文件夹",
  "dialog.project.new.directoryRequired": "请选择项目目录",
  "dialog.project.new.browse": "浏览",
  "dialog.project.new.workspacePreview": "项目工位",
  "dialog.project.new.resultPreview": "结果目录",
  "dialog.project.new.resultHint": "产物固定写在该项目工位下的 result/。",
  "dialog.project.new.isolateFailed": "无法把该项目从父目录里隔离开，请换一个文件夹再试。",
  "dialog.project.research.label": "分析方向",
  "dialog.project.research.hint": "方向在进入项目前选定，此处不可更改。要换方向请先返回「切换领域」。",
  "dialog.project.research.notes": "研究备注、约束或偏好方法",
  "dialog.project.new.description": "描述",
  "dialog.project.new.descriptionHint": "显示在项目列表中供参考，不会写入智能体提示词。",
  "dialog.project.new.descriptionPlaceholder": "描述这个项目是关于什么的…",
  "dialog.project.new.agentContext": "智能体上下文",
  "dialog.project.new.agentContextHint":
    "此内容会写入该项目每次对话的系统提示词，可用于背景信息、规范或所有智能体应遵循的说明。",
  "dialog.project.new.agentContextPlaceholder":
    "例如：本项目研究化合物 X 对细胞系 Z 中基因 Y 的影响。基因组参考统一使用 GRCh38…",
  "dialog.project.new.create": "创建",
  "dialog.project.new.updatedExisting": "已打开该项目并更新信息",
  "home.menu.pin": "置顶项目",
  "home.menu.unpin": "取消置顶",
  "home.menu.settings": "设置",
  "home.menu.delete": "删除项目",
  "home.menu.deleteConfirm.title": "删除项目？",
  "home.menu.deleteConfirm.message": "从列表中移除该项目？磁盘上的文件不会被删除。",
  "home.user.signOut": "退出登录",
  "home.user.signOutConfirm": "断开与 HYscience 服务器的连接？",
  ...
  "toast.update.description": "HYscience 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 HYscience 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (hyscience.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: HYscience 暂不支持 MCP 认证。',
  ...
  "home.empty.hint": "⌘K 命令面板 · ? 帮助",

  "home.capabilities.remove": "移除",
  "home.capabilities.skills.title": "Skills",
  "home.capabilities.skills.count": "· {{total}}",
  "home.capabilities.skills.category": "分类",
  "home.capabilities.skills.categoryAll": "全部",
  "home.capabilities.skills.uncategorized": "未分类",
  "home.capabilities.skills.search": "搜索技能…",
  "home.capabilities.skills.expand": "展开全部",
  "home.capabilities.skills.add": "添加技能",
  "home.capabilities.skills.addScratch": "从零编写",
  "home.capabilities.skills.addScratchHint": "在编辑器中撰写新的 SKILL.md",
  "home.capabilities.skills.addUpload": "上传技能",
  "home.capabilities.skills.addUploadHint": "从本地导入 SKILL.md 文件",
  "home.capabilities.skills.addGithub": "从 GitHub 导入",
  "home.capabilities.skills.addGithubHint": "从公开 git 仓库 URL 安装",
  "home.capabilities.skills.scratchTitle": "编写新技能",
  "home.capabilities.skills.scratchName": "名称",
  "home.capabilities.skills.scratchNamePh": "my-skill（字母、数字、-、_）",
  "home.capabilities.skills.scratchDesc": "描述",
  "home.capabilities.skills.scratchDescPh": "智能体何时应加载此技能？",
  "home.capabilities.skills.scratchBody": "说明（Markdown）",
  "home.capabilities.skills.scratchBodyPh": "步骤指引、代码示例、注意事项…",
  "home.capabilities.skills.githubTitle": "从 GitHub 导入",
  "home.capabilities.skills.githubUrl": "仓库 URL",
  "home.capabilities.skills.githubHint": "技能会先经过多层安全审查，通过后才会安装。",
  "home.capabilities.skills.create": "创建技能",
  "home.capabilities.skills.creating": "创建中…",
  "home.capabilities.skills.install": "安装",
  "home.capabilities.skills.installing": "安装中…",
  "home.capabilities.skills.created": "已创建 {{name}}",
  "home.capabilities.skills.createFailed": "创建失败",
  "home.capabilities.skills.uploaded": "已上传 {{name}}",
  "home.capabilities.skills.uploadFailed": "上传失败",
  "home.capabilities.skills.uploadInvalid": "SKILL.md 须包含带 name 与 description 的 frontmatter。",
  "home.capabilities.skills.installed": "已安装 {{count}} 个技能",
  "home.capabilities.skills.installNone": "未安装任何技能",
  "home.capabilities.skills.installRejected": "{{count}} 个未通过安全审查",
  "home.capabilities.skills.installFailed": "安装失败",
  "home.capabilities.skills.delete": "删除技能",
  "home.capabilities.skills.deleteConfirmTitle": "确认删除",
  "home.capabilities.skills.deleteConfirm": "删除技能「{{name}}」？此操作不可撤销。",
  "home.capabilities.skills.deleted": "已删除 {{name}}",
  "home.capabilities.skills.deleteFailed": "删除失败",
  "home.capabilities.skills.viewHint": "阅读全文",
  "home.capabilities.skills.enabled": "已启用",
  "home.capabilities.skills.disabled": "未启用",
  "home.capabilities.skills.enable": "启用",
  "home.capabilities.skills.location": "位置",
  "home.capabilities.skills.reading": "加载技能内容…",
  "home.capabilities.skills.readFailed": "无法读取技能内容",
  "home.capabilities.skills.loading": "加载技能…",
  "home.capabilities.skills.empty": "暂无技能",
  "home.dock.label": "工作台工具",
  "home.dock.skill": "skill",
  "home.dock.skillHint": "管理全部技能",
  "home.dock.computer": "computer",
  "home.dock.model": "Model",
  "home.dock.modelHint": "配置供应商、API Key，以及本智能体使用的模型",
  "home.capabilities.model.title": "Model",
  "home.capabilities.model.dockLead": "先接入供应商 API，再为本智能体选择模型。",
  "home.capabilities.model.ready": "{{count}} 个模型",
  "home.capabilities.model.needKey": "添加 API Key",
  "home.capabilities.model.agent": "本智能体",
  "home.capabilities.model.agentHint": "research harness · {{domain}}",
  "home.capabilities.model.default": "默认模型",
  "home.capabilities.model.auto": "自动",
  "home.capabilities.model.autoHint": "使用已连接供应商的第一个模型",
  "home.capabilities.model.subagent": "子任务模型",
  "home.capabilities.model.subagentHint": "标题、摘要与后台子任务",
  "home.capabilities.model.providers": "供应商 API",
  "home.capabilities.model.addKey": "添加 API Key",
  "home.capabilities.model.noProvider": "尚未连接供应商 — 添加 Key 后才会出现模型。",
  "home.capabilities.model.modelsCount": "{{count}} 个模型",
  "home.capabilities.model.provider": "供应商",
  "home.capabilities.model.apiKey": "API Key",
  "home.capabilities.model.saveKey": "保存 Key",
  "home.capabilities.model.keyHint": "密钥只存在本机，费用由对应供应商结算。",
  "home.capabilities.model.saveFailed": "无法保存 API Key",
  "home.capabilities.model.removeFailed": "无法移除 API Key",
  "home.capabilities.model.removeConfirm": "从本机移除 {{name}} 的 Key？",
  "home.capabilities.model.source.env": "环境变量",
  "home.capabilities.model.source.config": "配置文件",
  "home.capabilities.model.source.custom": "配置文件",
  "home.capabilities.model.lockedHint": "此 Key 来自{{source}}，需在来源处删除。",
  "home.capabilities.compute.dockLead": "选择任务跑在哪台机器。点齿轮配置 SSH 或 Cloud。",
  "home.capabilities.compute.title": "Compute",
  "home.capabilities.compute.loading": "加载 Compute…",
  "home.capabilities.compute.localTitle": "Local",
  "home.capabilities.compute.sshTitle": "SSH",
  "home.capabilities.compute.cloudTitle": "Cloud",
  "home.capabilities.compute.localSub": "本机 · 默认",
  "home.capabilities.compute.localScene": "bash · notebook · 本地脚本",
  "home.capabilities.compute.sshEmpty": "未配置 SSH 主机",
  "home.capabilities.compute.sshScene": "远程 GPU 集群 · Slurm 任务",
  "home.capabilities.compute.cloudEmpty": "未连接 Cloud Provider",
  "home.capabilities.compute.cloudScene": "Modal · RunPod · 按需 GPU",
  "home.capabilities.compute.localHint": "在本机执行任务与脚本。",
  "home.capabilities.compute.localMachine": "本机参数",
  "home.capabilities.compute.localHost": "主机",
  "home.capabilities.compute.localOs": "系统",
  "home.capabilities.compute.localCpu": "CPU",
  "home.capabilities.compute.localCores": "{{count}} 核",
  "home.capabilities.compute.localMemory": "内存",
  "home.capabilities.compute.localMemoryFree": "可用 {{free}}",
  "home.capabilities.compute.localActive": "当前默认执行环境",
  "home.capabilities.compute.localInactive": "未设为默认，点击 Local 卡片切换",
  "home.capabilities.compute.localLoading": "读取本机信息…",
  "home.capabilities.compute.hosts": "主机",
  "home.capabilities.compute.addHost": "添加 SSH 主机",
  "home.capabilities.compute.hostLabel": "名称",
  "home.capabilities.compute.hostAddress": "地址",
  "home.capabilities.compute.hostUser": "用户",
  "home.capabilities.compute.hostPort": "端口",
  "home.capabilities.compute.saveHost": "保存",
  "home.capabilities.compute.providers": "GPU Provider",
  "home.capabilities.compute.connected": "已连接",
  "home.capabilities.compute.notConnected": "未连接",
  "home.capabilities.compute.connect": "连接",
  ...
  "sidebar.gettingStarted.line1": "HYscience 提供免费模型，你可以立即开始使用。",
  ...
  "chat.welcome.title": "今天要在{{name}}中分析什么？",
  "chat.welcome.title.before": "今天要在",
  "chat.welcome.title.after": "中分析什么？",
  "chat.welcome.switchProject": "切换项目",
  "chat.welcome.lead": "描述你的科研问题，或从下方示例开始。",
  "chat.welcome.noModel": "尚未连接模型 — 配置后即可开始，可使用托管额度或自有 API Key。",
  "chat.welcome.setup": "配置模型 →",
  "chat.welcome.prompt1": "对单细胞 RNA-seq 数据做质控、归一化与聚类，并识别主要细胞类型。",
  "chat.welcome.prompt2": "分析 IMC / CODEX 空间蛋白组数据，比较组织区域间的细胞组成与邻域关系。",
  "chat.welcome.prompt3": "根据现有结果起草下一步实验计划，列出假设、指标与对照。",
  "chat.welcome.imc.1":
    "请按 IMC 标准分析流程处理数据：\n\n1. 数据转换：将原始 MCD 或 QPTIFF 统一转为 OME-TIFF，便于下游分析\n2. 预处理与细胞分割：识别每个细胞边界，输出 MASK\n3. 质控与归一化：去噪、去背景，并做细胞级过滤\n4. 细胞聚类及注释\n5. 空间分析：邻域、相互作用、patch 分析\n6. 下游统计比较：细胞比例与密度\n\n先确认数据路径与 panel，再按步骤执行。",
  "chat.welcome.imc.2": "规划 IMC 分割与表型：确认 panel / 通道，选择分割方法，并比较区域组成。",
  "chat.welcome.imc.3": "根据现有 IMC 邻域结果起草下一步实验计划，列出假设、指标与对照。",
  "chat.welcome.imc.flow.title": "IMC 标准分析流程",
  "chat.welcome.imc.flow.lead": "从原始成像到区域比较",
  "chat.welcome.imc.flow.s1": "数据转换",
  "chat.welcome.imc.flow.h1": "MCD / QPTIFF → OME-TIFF",
  "chat.welcome.imc.flow.s2": "预处理分割",
  "chat.welcome.imc.flow.h2": "细胞边界 → MASK",
  "chat.welcome.imc.flow.s3": "质控归一化",
  "chat.welcome.imc.flow.h3": "去噪去背景 · 细胞过滤",
  "chat.welcome.imc.flow.s4": "聚类注释",
  "chat.welcome.imc.flow.h4": "细胞分群与表型",
  "chat.welcome.imc.flow.s5": "空间分析",
  "chat.welcome.imc.flow.h5": "邻域 · 互作 · patch",
  "chat.welcome.imc.flow.s6": "下游统计",
  "chat.welcome.imc.flow.h6": "比例与密度比较",
  "chat.welcome.imc.flow.p1":
    "请执行 IMC 数据转换：将原始 MCD 或 QPTIFF 统一转为 OME-TIFF，便于下游分析。先确认数据路径与文件格式，再开始转换。",
  "chat.welcome.imc.flow.p2":
    "请执行 IMC 预处理与细胞分割：识别每个细胞边界并输出 MASK。先确认成像文件与 panel，再开始分割。",
  "chat.welcome.imc.flow.p3":
    "请执行 IMC 质控与归一化：去噪、去背景，并做细胞级过滤。先确认分割结果与质控阈值，再开始处理。",
  "chat.welcome.imc.flow.p4": "请执行 IMC 细胞聚类及注释：对分割后的细胞分群，并完成表型注释。",
  "chat.welcome.imc.flow.p5": "请执行 IMC 空间分析：包括细胞邻域、相互作用与 patch 分析。",
  "chat.welcome.imc.flow.p6": "请执行 IMC 下游统计比较：统计细胞比例与密度，并比较组织区域差异。",
  "chat.welcome.single-cell.1": "对单细胞 RNA-seq 数据做质控、归一化与聚类，并识别主要细胞类型。",
  "chat.welcome.single-cell.2": "整合多个 scRNA 样本并校正批次，比较各样本的细胞组成。",
  "chat.welcome.single-cell.3": "根据现有聚类与注释结果起草下一步实验计划，列出假设、指标与对照。",
  "chat.welcome.spatial.1": "分析 Visium / Stereo-seq 空间转录组，做空间邻域与配体受体推断。",
  "chat.welcome.spatial.2": "用单细胞参考对空间数据进行去卷积，比较各区域的细胞组成。",
  "chat.welcome.spatial.3": "根据现有空间分布结果起草下一步实验计划，列出假设、指标与对照。",
  "chat.welcome.genomics.1": "对 WGS / WES 数据做比对与变异检测，并注释致病性。",
  "chat.welcome.genomics.2": "对表达矩阵做差异分析与通路富集，汇总显著基因。",
  "chat.welcome.genomics.3": "根据现有变异或表达结果起草下一步实验计划，列出假设、指标与对照。",
  "chat.welcome.general.1": "对单细胞 RNA-seq 数据做质控、归一化与聚类，并识别主要细胞类型。",
  "chat.welcome.general.2": "分析 IMC / CODEX 空间蛋白组数据，比较组织区域间的细胞组成与邻域关系。",
  "chat.welcome.general.3": "根据现有结果起草下一步实验计划，列出假设、指标与对照。",
  ...
  "settings.general.row.language.description": "更改 HYscience 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 HYscience 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 HYscience 的主题。",
  "settings.general.row.font.title": "字体",
  "settings.general.row.font.description": "自定义代码块使用的等宽字体",
  "settings.general.row.fontSize.title": "字体大小",
  "settings.general.row.fontSize.description": "调整界面与对话的正文字号",
  "settings.general.row.fontSize.12": "小",
  "settings.general.row.fontSize.14": "默认",
  "settings.general.row.fontSize.16": "大",
  "settings.general.row.fontSize.18": "特大",
  ...
  "settings.updates.row.startup.description": "在 HYscience 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 HYscience。",
  ...
  "domain.guide.title": "选择分析方向",
  "domain.guide.lead": "先选领域，再进入该方向下的项目",
  "domain.guide.enter": "进入",
  "domain.guide.skills": "配置 Skill",
  "domain.guide.skillsTitle": "Skills · {{domain}}",
  "domain.guide.skillsHint": "已开启的技能属于当前方向；未开启的仍可见，可手动打开或关闭。",
  ...
  "domain.imc.title": "空间蛋白成像",
  "domain.imc.point1": "IMC / CODEX / MIBI 细胞分割与表型",
  "domain.imc.point2": "邻域与空间互作",
  "domain.imc.point3": "区域组成比较",
  "domain.single-cell.title": "单细胞分析",
  "domain.single-cell.point1": "质控、归一化、聚类",
  "domain.single-cell.point2": "Marker 注释与差异基因",
  "domain.single-cell.point3": "批次整合",
  "domain.spatial.title": "空间转录组",
  "domain.spatial.point1": "Visium / Stereo-seq 等平台",
  "domain.spatial.point2": "空间邻域与配体受体",
  "domain.spatial.point3": "与单细胞数据整合",
  "domain.genomics.title": "基因组分析",
  "domain.genomics.point1": "比对与变异分析",
  "domain.genomics.point2": "基因注释与富集",
  "domain.genomics.point3": "表达定量",
  "domain.general.title": "通用研究",
  "domain.general.point1": "跨领域研究问题",
  "domain.general.point2": "文献与实验设计",
  "domain.general.point3": "不限定单一组学流程",

  "rightpane.label": "本轮工作台",
  "rightpane.expand": "展开工作台",
  "rightpane.collapse": "收起工作台",
  "rightpane.tab.now": "本轮",
  "rightpane.tab.evidence": "证据",
  "rightpane.tab.run": "运行",
  "rightpane.tab.agents": "协作",
  "rightpane.now.locked": "主题已锁定",
  "rightpane.now.open": "不锁主题",
  "rightpane.now.switchHint": "换方向请先回到领域页切换。",
  "rightpane.now.stage": "阶段",
  "rightpane.now.doing": "正在做",
  "rightpane.now.idle": "等待下一轮",
  "rightpane.now.stageLit": "文献",
  "rightpane.now.stageCompute": "计算",
  "rightpane.now.stageWrite": "写作",
  "rightpane.now.stageTalk": "对话",
  "rightpane.now.files": "本轮产物",
  "rightpane.now.filesEmpty": "这一轮还没有写出文件。",
